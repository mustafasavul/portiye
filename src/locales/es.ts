...
export const es: Strings = {
  ...
  "lan.copy": "Copiar esta dirección",
  "lan.copied": "Copiado",
  ...
  "system.disk": "Disco",
  "system.load": "carga actual",
  "ports.children": "Relacionados",
  "ports.childrenTitle": "Anida cada proceso bajo el que lo inició. Desactivado, cada proceso ocupa su propia fila: no se oculta nada.",
  "settings.open": "Ajustes",
  "settings.panels": "Paneles",
  "settings.devicesHint": "Emuladores, simuladores y contenedores.",
  "settings.systemHint": "Los cuatro medidores a la vez.",
  "settings.columns": "Columnas y medidores",
  "settings.cpuHint": "Oculta la columna y el medidor de CPU. No se ejecuta nada extra de todos modos.",
  "settings.gpuHint": "Desactivado, la GPU nunca se mide: sin sondeo en cada escaneo, sin muestreo de nvidia-smi.",
  "settings.diskHint": "Oculta la columna y el medidor de disco.",
  "settings.tray": "Barra de menús",
  "settings.trayVisible": "Mostrar el icono",
  "settings.trayVisibleHint": "Sin él, cerrar la ventana sale de portiye en lugar de ocultarlo.",
  "settings.trayStats": "Línea de carga",
  "settings.trayStatsHint": "La única línea al principio del menú.",
  "settings.trayPortsHint": "El submenú de puertos.",
  "settings.trayDevicesHint": "El submenú de dispositivos.",
  "settings.ports": "Puertos",
  "settings.flagHint": "Los procesos por encima de esto se marcan en la tabla de puertos.",
  "settings.export": "Exportar",
  "settings.formatHint": "Lo que Exportar escribe en tu carpeta de Descargas.",
  "settings.startup": "Inicio",
  "settings.startupFailed": "No se pudo escribir el elemento de inicio: {error}",
