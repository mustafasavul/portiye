...
export const tr: Strings = {
  ...
  "lan.copy": "Bu adresi kopyala",
  "lan.copied": "Kopyalandı",
  ...
  "settings.cpuHint":
    "CPU sütununu ve göstergesini gizler. Kapalıyken de ek bir iş çalışmaz.",
  "settings.gpuHint":
    "Kapalıyken GPU hiç ölçülmez: her taramada sorgu yok, nvidia-smi örnekleyicisi yok.",
  "settings.diskHint": "Disk sütununu ve göstergesini gizler.",
  "settings.tray": "Menü çubuğu",
  "settings.trayVisible": "Simgeyi göster",
  "settings.trayVisibleHint":
    "Simge olmadan pencereyi kapatmak portiye'yi gizlemek yerine kapatır.",
  "settings.trayStats": "Yük satırı",
  "settings.trayStatsHint": "Menünün en üstündeki tek satır.",
  "settings.trayPortsHint": "Portlar alt menüsü.",
  "settings.trayDevicesHint": "Cihazlar alt menüsü.",
  "settings.ports": "Portlar",
  "settings.flagHint": "Bunun üstündeki süreçler port tablosunda işaretlenir.",
  "settings.export": "Dışa aktarma",
  "settings.formatHint": "Dışa Aktar'ın İndirilenler klasörüne yazdığı biçim.",
  "settings.startup": "Başlangıç",
  "settings.startupFailed": "Açılış öğesi yazılamadı: {error}",
  ...
  "history.kind": "Olay türü",
  "history.all": "Tümü",
  "history.opened": "Açıldı",
  "history.closed": "Kapandı",
  "history.taken": "Devralındı",
  "history.event": "Olay",
  "history.when": "Zaman",
  "history.filter": "Olaylarda ara",
  "history.filterAria": "Olayları port, süreç veya yola göre filtrele",
  "history.emptyFilter": "Bu filtreyle eşleşen olay yok.",
