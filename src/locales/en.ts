...
export const en = {
  ...
  "settings.trayVisibleHint":
    "Without it, closing the window quits portiye instead of hiding it.",
  "settings.trayStats": "Load readout",
  "settings.trayStatsHint": "The one line at the top of the menu.",
  "settings.trayPortsHint": "The ports submenu.",
  "settings.trayDevicesHint": "The devices submenu.",
  "settings.ports": "Ports",
  "settings.flagHint": "Processes above this are marked in the port table.",
  "settings.export": "Export",
  "settings.formatHint": "What Export writes to your Downloads folder.",
  "settings.startup": "Startup",
  "settings.startupFailed": "Could not write the login item: {error}",
  ...
  "history.kind": "Event type",
  "history.all": "All",
  "history.opened": "Opened",
  "history.closed": "Closed",
  "history.taken": "Taken over",
  "history.event": "Event",
  "history.when": "When",
  "history.filter": "Filter events",
  "history.filterAria": "Filter events by port, process or path",
  "history.emptyFilter": "No event matches this filter.",
