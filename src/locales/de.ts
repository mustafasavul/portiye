...
export const de: Strings = {
  ...
  "lan.copy": "Diese Adresse kopieren",
  "lan.copied": "Kopiert",
  "system.title": "System",
  "system.cpu": "CPU",
  "system.gpu": "GPU",
  ...
  "system.load": "aktuelle Last",
  "ports.children": "Verwandte",
  "ports.childrenTitle": "Jeden Prozess unter dem verschachteln, der ihn gestartet hat. Aus bekommt jeder Prozess eine eigene Zeile — nichts wird ausgeblendet.",
  "settings.open": "Einstellungen",
  "settings.panels": "Bereiche",
  "settings.devicesHint": "Emulatoren, Simulatoren und Container.",
  "settings.systemHint": "Alle vier Anzeigen auf einmal.",
  "settings.columns": "Spalten und Anzeigen",
  "settings.cpuHint": "Blendet CPU-Spalte und -Anzeige aus. Es läuft so oder so nichts zusätzlich.",
  "settings.gpuHint": "Aus wird die GPU nie gemessen: keine Abfrage pro Scan, kein nvidia-smi-Sampler.",
  "settings.diskHint": "Blendet Festplattenspalte und -Anzeige aus.",
  "settings.tray": "Menüleiste",
  "settings.trayVisible": "Symbol anzeigen",
  "settings.trayVisibleHint": "Ohne Symbol beendet das Schließen des Fensters portiye, statt es auszublenden.",
  "settings.trayStats": "Lastzeile",
  "settings.trayStatsHint": "Die eine Zeile oben im Menü.",
  "settings.trayPortsHint": "Das Untermenü „Ports“.",
  "settings.trayDevicesHint": "Das Untermenü „Geräte“.",
  "settings.ports": "Ports",
  "settings.flagHint": "Prozesse darüber werden in der Port-Tabelle markiert.",
  "settings.export": "Export",
  "settings.formatHint": "Was der Export in deinen Downloads-Ordner schreibt.",
  "settings.startup": "Start",
  "settings.startupFailed": "Anmeldeobjekt konnte nicht geschrieben werden: {error}",
  "settings.about": "Über",
  "history.kind": "Ereignistyp",
  "history.all": "Alle",
  "history.opened": "Geöffnet",
  "history.closed": "Geschlossen",
  "history.taken": "Übernommen",
